...
// TODO: Update with official Monad chain details when available
export const monad = defineChain({
  id: parseInt(process.env.NEXT_PUBLIC_MONAD_CHAIN_ID || '10143'), // Monad testnet chain ID (placeholder)
  name: 'Monad',
  nativeCurrency: {
    name: 'Monad',
    symbol: 'MON',
