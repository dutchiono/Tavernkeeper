...
ERC-6551 (Token Bound Accounts) allows NFTs to have their own smart contract wallets. In InnKeeper, each hero has a TBA that can hold items, tokens, and other assets.
