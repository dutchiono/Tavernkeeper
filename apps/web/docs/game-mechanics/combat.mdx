...
InnKeeper features a turn-based combat system with initiative, attacks, damage calculation, and skill checks. All combat is deterministic based on the dungeon seed.
