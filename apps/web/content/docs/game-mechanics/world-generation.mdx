...
InnKeeper features a hierarchical world generation system that creates a rich, interconnected world from cosmic forces down to individual mortals. The world includes geography, organizations, and lore.
