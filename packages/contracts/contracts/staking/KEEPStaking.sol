...
/**
 * @title KEEPStaking
 * @notice Staking contract for KEEP tokens with lock periods and KEEP rewards
 */
contract KEEPStaking is Ownable, ReentrancyGuard {
    using SafeERC20 for IERC20;

    IERC20 public immutable stakingToken; // KEEP
    ...
    /**
     * @notice Stake KEEP tokens with optional lock period
     * @param amount Amount of KEEP to stake
    ...
    /**
     * @notice Unstake KEEP tokens (respects lock period)
     * @param amount Amount of KEEP to unstake
     */
