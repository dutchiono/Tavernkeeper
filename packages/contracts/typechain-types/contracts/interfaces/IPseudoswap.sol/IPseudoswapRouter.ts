...
export interface IPseudoswapRouterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "WETH"
      | "addLiquidity"
...
export interface IPseudoswapRouter extends BaseContract {
  connect(runner?: ContractRunner | null): IPseudoswapRouter;
  waitForDeployment(): Promise<this>;

  interface: IPseudoswapRouterInterface;
