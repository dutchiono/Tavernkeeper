...
export interface InventoryInterface extends Interface {
  getFunction(
    nameOrSignature:
  ...
  encodeFunctionData(
    functionFragment: "claimLootWithFee",
    values: [
      AddressLike,
      AddressLike,
      BigNumberish[],
...
export interface Inventory extends BaseContract {
  connect(runner?: ContractRunner | null): Inventory;
  ...
  claimLootWithFee: TypedContractMethod<
    [
      from: AddressLike,
      to: AddressLike,
      ids: BigNumberish[],
  ...
  >;
  getFunction(
    nameOrSignature: "claimLootWithFee"
  ): TypedContractMethod<
    [
      from: AddressLike,
      to: AddressLike,
